...
<html lang="en">
  <head>
    ...
    <title>Home page of simply ATM</title>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Simply Online ATM</h1>
            <p class="lead">Welcome to my simply ATM project, it was built by using Spring, Spring MVC, and Spring JDBC and Hibernate for
            Database access.</p>
            <p class="lead">
              <a href="http://www.github.com/williaz/SpringExample/tree/master/SimpleATM" class="btn btn-lg btn-default">Learn more</a>
            </p>
          </div>
